...
export const TasksApp = () => {
  ...
  const addTodo = () => {
    ...
    /*todos.push(newTodo) DON'T INSERT AS THIS WAY
      The correct way is like behind
    */

    setTodos([...todos, newTodo]); // Inserting to the end our new todo
    // setTodos((prev) => [...todos, newTodo]) // Another way to insert a todo
    setInputValue(""); // Cleaning the text box
  };
